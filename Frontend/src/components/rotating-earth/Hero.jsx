  ...
  return (
    ...
    >
      <div className="text-center text-white bg-transparent p-4 rounded-lg w-svw font-sans">
        ...
        <button className="bg-transparent hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-full transition duration-300 font-sans backdrop-filter backdrop-blur-md bg-opacity-30 border border-white border-opacity-50">
